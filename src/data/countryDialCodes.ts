...
// ISO country and territory calling codes used by the public contact form.
// Some NANP countries share +1; the more specific prefix is shown where useful.
export const countryDialCodes: CountryDialCode[] = [
  ["AF", "Afghanistan", "+93"], ["AX", "Åland Islands", "+35818"], ["AL", "Albania", "+355"],
  ["DZ", "Algeria", "+213"], ["AS", "American Samoa", "+1684"], ["AD", "Andorra", "+376"],
  ["AO", "Angola", "+244"], ["AI", "Anguilla", "+1264"], ["AQ", "Antarctica", "+672"],
  ["AG", "Antigua and Barbuda", "+1268"], ["AR", "Argentina", "+54"], ["AM", "Armenia", "+374"],
  ["AW", "Aruba", "+297"], ["AU", "Australia", "+61"], ["AT", "Austria", "+43"],
  ["AZ", "Azerbaijan", "+994"], ["BS", "Bahamas", "+1242"], ["BH", "Bahrain", "+973"],
  ["BD", "Bangladesh", "+880"], ["BB", "Barbados", "+1246"], ["BY", "Belarus", "+375"],
  ["BE", "Belgium", "+32"], ["BZ", "Belize", "+501"], ["BJ", "Benin", "+229"],
  ["BM", "Bermuda", "+1441"], ["BT", "Bhutan", "+975"], ["BO", "Bolivia", "+591"],
  ["BQ", "Bonaire, Sint Eustatius and Saba", "+599"], ["BA", "Bosnia and Herzegovina", "+387"],
  ["BW", "Botswana", "+267"], ["BV", "Bouvet Island", "+47"], ["BR", "Brazil", "+55"],
  ["IO", "British Indian Ocean Territory", "+246"], ["BN", "Brunei", "+673"], ["BG", "Bulgaria", "+359"],
  ...
  ["CL", "Chile", "+56"], ["CN", "China", "+86"], ["CX", "Christmas Island", "+61"],
  ["CC", "Cocos (Keeling) Islands", "+61"], ["CO", "Colombia", "+57"], ["KM", "Comoros", "+269"],
  ["CG", "Congo", "+242"], ["CD", "Congo, Democratic Republic of the", "+243"], ["CK", "Cook Islands", "+682"],
  ...
  ["ET", "Ethiopia", "+251"], ["FK", "Falkland Islands", "+500"], ["FO", "Faroe Islands", "+298"],
  ["FJ", "Fiji", "+679"], ["FI", "Finland", "+358"], ["FR", "France", "+33"],
  ["GF", "French Guiana", "+594"], ["PF", "French Polynesia", "+689"], ["TF", "French Southern Territories", "+262"],
  ...
  ["GY", "Guyana", "+592"], ["HT", "Haiti", "+509"], ["HM", "Heard Island and McDonald Islands", "+672"],
  ["VA", "Holy See (Vatican City)", "+39"], ["HN", "Honduras", "+504"], ["HK", "Hong Kong", "+852"],
  ...
  ["KE", "Kenya", "+254"], ["KI", "Kiribati", "+686"], ["KP", "Korea, North", "+850"],
  ["KR", "Korea, South", "+82"], ["XK", "Kosovo", "+383"], ["KW", "Kuwait", "+965"],
  ...
  ["PH", "Philippines", "+63"], ["PN", "Pitcairn Islands", "+64"], ["PL", "Poland", "+48"],
  ...
  ["GS", "South Georgia and the South Sandwich Islands", "+500"], ["SS", "South Sudan", "+211"],
  ...
  ["TR", "Türkiye", "+90"], ["TM", "Turkmenistan", "+993"], ["TC", "Turks and Caicos Islands", "+1649"],
  ["TV", "Tuvalu", "+688"], ["UG", "Uganda", "+256"], ["UA", "Ukraine", "+380"],
  ["AE", "United Arab Emirates", "+971"], ["GB", "United Kingdom", "+44"], ["US", "United States", "+1"],
  ["UM", "United States Minor Outlying Islands", "+1"], ["UY", "Uruguay", "+598"], ["UZ", "Uzbekistan", "+998"],
  ["VU", "Vanuatu", "+678"], ["VE", "Venezuela", "+58"], ["VN", "Vietnam", "+84"],
  ["VG", "Virgin Islands, British", "+1284"], ["VI", "Virgin Islands, U.S.", "+1340"],
  ["WF", "Wallis and Futuna", "+681"], ["EH", "Western Sahara", "+212"], ["YE", "Yemen", "+967"],
  ["ZM", "Zambia", "+260"], ["ZW", "Zimbabwe", "+263"],
].map(([iso2, name, dialCode]) => ({ iso2, name, dialCode }));

export const countryFlag = (iso2: string) =>
  iso2
    .toUpperCase()
    .split("")
