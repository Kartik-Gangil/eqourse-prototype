...
const reasons = [
  ...
  {
    title: "Global Impact",
    description: "With commercial leadership in Singapore, India-led delivery and clients in 15+ countries, your work at eQOURSE reaches learners and AI systems worldwide.",
    icon: Globe2,
