...
export const aiDataServicesCategories: AIDataNavCategory[] = [
  ...
  },
  {
    ...
    subServices: [
      ...
      { label: "Robot Interaction Data", href: "/robotics-training-data-services/human-demonstrations#collection-methods", icon: Bot, description: "Teleoperation trajectories, robot states, interventions and task outcomes.", serviceHighlights: ["Action trajectories", "Joint and state logs", "Operator interventions", "Success and recovery outcomes", "Client-approved robots and environments"] },
