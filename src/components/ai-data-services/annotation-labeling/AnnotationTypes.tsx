...
const services = [
  ...
  { icon: TextCursorInput, title: "Text & NLP Annotation", description: "Language data structured for LLMs, search, chatbots and document AI.", tasks: ["Named entities", "Sentiment & aspects", "Text classification", "Relation extraction", "Intent & slots", "MT post-editing"], href: "/ai-data-services/annotation-labeling/text-nlp-annotation" },
  { icon: AudioLines, title: "Audio & Speech Annotation", description: "Speech data prepared for ASR, voice assistants and conversational AI.", tasks: ["Transcription", "Speaker diarization", "Emotion & tone", "Audio events", "Phonetics", "Wake words"], href: "/ai-data-services/annotation-labeling/audio-speech-annotation" },
  ...
  { icon: Box, title: "3D Point Cloud & LiDAR", description: "Spatial labeling for autonomous systems, robotics and physical AI.", tasks: ["3D cuboids", "Point segmentation", "Sensor fusion", "Sweep tracking", "Lane & drivable space"], href: "/ai-data-services/annotation-labeling/3d-point-cloud-lidar-annotation" },
  ...
  { icon: MessageSquareWarning, title: "Content Moderation & Trust/Safety", description: "Ongoing policy enforcement with contextual review, appeals and moderator safeguards.", tasks: ["Severity tiers", "Context review", "Appeals", "Spam & fraud", "Multilingual moderation"], href: "/ai-data-services/annotation-labeling/content-moderation" },
];
