...
export const WhyEqourse = () => {
  const reasons = ["Subject-matter experts for judgement-led work", "Collection, annotation, validation and testing under one contract", "Written specifications and versioned edge-case rulings", "Deep Indic and multilingual coverage", "500+ specialists supporting global delivery", "ISO 9001 and ISO 27001 certified processes", "Free pilot against your own acceptance threshold"];
