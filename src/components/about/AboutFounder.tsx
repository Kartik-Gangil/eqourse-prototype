          ...
          <div className="w-full lg:w-7/12">
            ...
            >
              ...
              <div className="space-y-5 text-muted-foreground leading-relaxed text-lg mb-10">
                ...
                <p>
                  In 2020, Somveer founded eQOURSE with a vision to bring operational excellence to education and AI services. Under his leadership, eQOURSE has grown into a global learning content and AI data solutions provider serving 200+ clients. In 2025, he established EQOURSE PTE. LTD. as the Singapore commercial headquarters for international engagements, client accounts, partnerships and contracting.
                </p>
              </div>
