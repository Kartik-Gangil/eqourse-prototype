...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    fullDesc: "By 2025, our systems had evolved into integrated pipelines connecting AI-supported workflows, content creation, localization, video production and assessments. EQOURSE PTE. LTD. became our Singapore commercial headquarters for international engagements and client accounts, while TUTRAIN enabled real-user feedback and continuous refinement across AI and learning systems.",
  ...
  },
  {
    ...
    fullDesc: "Today, eQOURSE operates as a mature dual-capability ecosystem where AI data pipelines, learning content systems, multilingual delivery frameworks, and real-world validation mechanisms function together continuously. With global delivery capabilities, scalable infrastructure, and integrated execution models, we continue building meaningful impact across intelligent and learning systems worldwide.",
