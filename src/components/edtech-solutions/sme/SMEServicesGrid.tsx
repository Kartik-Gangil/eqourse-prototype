...
const services = [
  {
    ...
    link: "/content-service/subject-matter-experts/recruitment",
    color: "hsl(170 82% 45%)"
  },
  {
    icon: BookOpenCheck,
    ...
    link: "/content-service/subject-matter-experts/training-certification",
    color: "hsl(280 80% 65%)"
  },
  {
    icon: MonitorPlay,
    ...
    link: "/content-service/subject-matter-experts/live-tutors",
