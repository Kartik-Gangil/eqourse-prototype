...
export const edtechCategories: EdTechCategory[] = [
  {
    ...
    href: "/content-service/custom-e-learning-content",
    icon: BookOpen,
    ...
    subServices: [
      {
        label: "K12 & Higher Education", href: "/content-service/custom-e-learning-content/k12-and-higher-education", icon: GraduationCap,
      ...
      {
        label: "K12 Curriculum Development", href: "/content-service/custom-e-learning-content/k12-curriculum-development", icon: Layout,
      ...
      {
        label: "Assessment Development", href: "/content-service/custom-e-learning-content/assessment-development", icon: ClipboardCheck,
      ...
      {
        label: "Educational Content Development", href: "/content-service/custom-e-learning-content/educational-content-development", icon: FileText,
      ...
      {
        label: "Workbook Development", href: "/content-service/custom-e-learning-content/workbook-development", icon: BookMarked,
      ...
      {
        label: "Teacher Lesson Plan", href: "/content-service/custom-e-learning-content/teacher-lesson-plan", icon: CalendarDays,
      ...
      {
        label: "STEM Curriculum Services", href: "/content-service/custom-e-learning-content/stem-curriculum-services", icon: FlaskConical,
      ...
      {
        label: "E-Book Creation", href: "/content-service/custom-e-learning-content/ebook-creation", icon: TabletSmartphone,
      ...
      {
        label: "2D & 3D Videos", href: "/content-service/custom-e-learning-content/2d-3d-videos", icon: Film,
      ...
      {
        label: "Quiz & Question Bank", href: "/content-service/custom-e-learning-content/quiz-question-bank", icon: HelpCircle,
  ...
  },
  {
    ...
    href: "/content-service/elearning-video-solutions",
    icon: Clapperboard,
    ...
    subServices: [
      {
        label: "PPT Video Services", href: "/content-service/elearning-video-solutions/ppt-videos", icon: MonitorPlay,
        serviceHighlights: ["PPT to Video Conversion", "Voice-Over Integration", "Animation & Transitions", "Pen-Tab Video Lessons"],
      },
      {
        label: "Articulate Storyline", href: "/content-service/elearning-video-solutions/articulate-storyline", icon: MousePointerClick,
        serviceHighlights: ["Branching Scenarios", "Interactive Simulations", "Drag & Drop Activities", "SCORM/xAPI Packaging"],
      },
      {
        label: "Animated Video Services", href: "/content-service/elearning-video-solutions/animated-videos", icon: Video,
  ...
  },
  {
    ...
    href: "/content-service/localization-services",
    icon: Globe,
    ...
    subServices: [
      {
        label: "Translation Services", href: "/content-service/localization-services/translation", icon: Languages,
        serviceHighlights: ["Curriculum Translation", "Assessment Translation", "E-Learning Module Translation", "Document Translation"],
      },
      {
        label: "Voice Over Services", href: "/content-service/localization-services/voice-over", icon: Mic,
        serviceHighlights: ["Male & Female Voice Artists", "Studio-Quality Recording", "Script Timing & Sync", "Multiple Accent Options"],
      },
      {
        label: "Subtitling Services", href: "/content-service/localization-services/subtitling", icon: Captions,
  ...
  },
  {
    ...
    href: "/content-service/technology-solutions",
    icon: Laptop,
    ...
    subServices: [
      {
        label: "LMS Course Builds", href: "/content-service/technology-solutions/lms-course-builds", icon: HardDrive,
        serviceHighlights: ["SCORM Course Packaging", "xAPI/Tin Can Integration", "Multi-LMS Testing", "Course Structure Design"],
      },
      {
        label: "White Label LMS", href: "/content-service/technology-solutions/white-label-lms", icon: Server,
  ...
  },
  {
    ...
    href: "/content-service/subject-matter-experts",
    icon: Users,
    ...
    subServices: [
      {
        label: "SME Recruitment", href: "/content-service/subject-matter-experts/recruitment", icon: UserCheck,
        serviceHighlights: ["Subject-Specific Recruitment", "Screening & Vetting", "Bulk Recruitment", "Freelancer & Full-Time Options"],
      },
      {
        label: "SME Training & Certification", href: "/content-service/subject-matter-experts/training", icon: BookOpenCheck,
        serviceHighlights: ["Content Standards Training", "Pedagogy Workshops", "Platform Tool Training", "Certification Programs"],
      },
      {
        label: "Live Online Tutors", href: "/content-service/subject-matter-experts/live-online-tutors", icon: MonitorPlay,
