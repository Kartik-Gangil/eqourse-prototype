    ...
    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
      ...
      <div className="group relative rounded-2xl bg-card p-8 border border-border shadow-card hover:shadow-elevated transition-all duration-500 reveal-up transform-style-3d hover:-translate-y-2">
        ...
        <div className="relative z-10 flex flex-col h-full translate-z-6">
          ...
          <h3 className="font-heading text-2xl font-bold text-foreground mb-4">Content Service</h3>
          ...
          <Link to="/content-services" className="inline-flex items-center text-primary font-semibold hover:text-primary/80 transition-colors group/link">
            Explore Content Services Services
