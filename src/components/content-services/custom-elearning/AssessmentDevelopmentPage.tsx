...
const AssessmentDevelopmentPage = () => (
  <SubServicePageTemplate
    ...
    subtext="At eQOURSE, we provide customized K-12 Assessment Development Services for content services institutions and e-learning platforms. Our services include creating interactive quizzes, tests, and assignments that align with your educational goals. We leverage advanced technology to develop assessments that work seamlessly across desktops, smartphones, and tablets."
