...
const K12HigherEducationPage = () => (
  <SubServicePageTemplate
    ...
    subtext="At eQOURSE, we provide specialized K-12 Content Services and Higher Education Solutions to institutions and e-learning platforms. Our team of over 100+ subject matter experts (SMEs) excels in offering tailored curriculum development, assessment creation, and e-learning content designed to meet the unique needs of your institution."
