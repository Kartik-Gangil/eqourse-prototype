...
export const contentServicesCategories: ContentServicesCategory[] = [
  ...
  },
  {
    ...
    subServices: [
      ...
      { label: "Document & eContent Remediation", href: "/content-services/accessibility/document-content-remediation", icon: FileText, serviceHighlights: ["PDF Remediation", "eBook Accessibility", "LMS Course Remediation", "HTML & Word"] },
      { label: "Accessible Media & Enhancements", href: "/content-services/accessibility/accessible-media-enhancements", icon: Video, serviceHighlights: ["Alt Text Authoring", "Captioning & Transcripts", "Audio Description", "Accessible STEM"] },
      { label: "Assessment Accessibility", href: "/content-services/accessibility/assessment-accessibility", icon: ClipboardCheck, serviceHighlights: ["Accessible Item Design", "Keyboard Navigation", "Screen Reader Review", "Non-text Alternatives"] },
      { label: "Assistive Technology Compatibility", href: "/content-services/accessibility/assistive-technology-compatibility", icon: MonitorPlay, serviceHighlights: ["Screen Reader Testing", "Keyboard Accessibility", "Usability Testing", "Focus Order Review"] },
      { label: "Audit & Compliance Support", href: "/content-services/accessibility/audit-compliance-support", icon: ShieldCheck, serviceHighlights: ["Accessibility Audits", "Gap Analysis", "ACR Support", "VPAT Documentation"] },
    ],
  },
  {
    ...
    subServices: [
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/psychometric-assessments",
        icon: Brain,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/skill-assessments",
        icon: ClipboardCheck,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/candidate-evaluation",
        icon: UserCheck,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/competency-frameworks",
        icon: Layout,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/learning-readiness",
        icon: GraduationCap,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/organizational-diagnostics",
        icon: Brain,
      ...
      },
      {
        ...
        href: "/content-services/talent-assessment-workforce-evaluation/digital-assessment-infrastructure",
        icon: Laptop,
