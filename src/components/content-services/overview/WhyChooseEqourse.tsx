...
const reasons = [
  ...
  { icon: BookOpen, title: "Global Delivery", description: "Commercially headquartered in Singapore, with operational headquarters and primary delivery in Kota, India." },
