...
export const contentServicesSamples: ContentServicesSample[] = [
  ...
  // T1-T8: Text Sub-Pages
  {
    ...
    heroImageAlt:
      "K12 Grade text samples for KG-5, providing study guides and lesson plans for early education, customized for content services platforms.",
  ...
  },
  {
    ...
    heroImageAlt:
      "K12 Grade text samples for classes 6-12, offering study guides and assessments for content services platforms seeking content solutions.",
    tabs: ["Course Book", "Lesson Plan", "Work Book"],
    faqs: commonFaqs,
  },
  {
